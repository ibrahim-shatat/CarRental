              ...
              <div class="card-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-select form-select-sm" name="guard_name" style="width: 100%;"
                        ...
                        <option value="renter" @if($permissions->guard_name == 'renter') selected @endif>Renter</option>
                        <option value="buyer" @if($permissions->guard_name == 'buyer') selected @endif>Buyer</option>
                    </select>
               </div>
           </div>
