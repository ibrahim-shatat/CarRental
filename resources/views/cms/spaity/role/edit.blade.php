              ...
              <div class="card-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-select form-select-sm" name="guard_name" style="width: 100%;"
                        ...
                        <option value="supplier" @if($roles->guard_name == 'supplier') selected @endif>Supplier</option>
                        <option value="renter" @if($roles->guard_name == 'renter') selected @endif>Renter</option>
                        <option value="buyer" @if($roles->guard_name == 'buyer') selected @endif>Buyer</option>
                    </select>
               </div>
           </div>
