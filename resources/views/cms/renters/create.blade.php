...
@section('main-title', 'Create Renter')

@section('sub-title', 'Create Renter')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Create New Renter</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name"
                                            placeholder="Enter First Name of Renter">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="last_name">Last Name of Renter</label>
                                        <input type="text" class="form-control" id="last_name" name="last_name"
                                            placeholder="Enter Last Name of Renter">
                                    </div>
                                </div>
...
@section('scripts')
    <script>
        function performStore() {
            ...
            store('/cms/admin/renters', formData)
